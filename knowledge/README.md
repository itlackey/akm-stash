...
| # | Ref | Read when |
| --- | --- | --- |
| 1 | `knowledge/akm-overview` | First time meeting akm — asset types, the major 0.9.2 surfaces, and how the pieces fit together. |
...
| 3 | `knowledge/akm-stash-structure` | You're authoring or reorganizing a bundle and need the 0.9.2 directory/command/workflow/task/lesson conventions. |
...
and version-pinned to akm-cli 0.9.2. They teach *how* rather than answer
