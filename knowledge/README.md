...
| # | Ref | Read when |
| --- | --- | --- |
| 1 | `knowledge/akm-overview` | First time meeting akm — asset types, the major 0.9.0 surfaces, and how the pieces fit together. |
...
| 3 | `knowledge/akm-stash-structure` | You're authoring or reorganizing a stash and need the 0.9.0 directory/command/workflow/task/lesson conventions. |
...
and version-pinned to akm-cli 0.9.0. They teach *how* rather than answer
