---
description: Use when an agent needs the 0.9.7 proposal queue, quality values, and lesson lifecycle explained clearly.
...
There is no bare `akm proposal` (no verb) — it is a usage error in 0.9.7;
